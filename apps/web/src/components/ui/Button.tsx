...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "primary", size = "md", loading, children, className = "", disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-brand-gold hover:bg-brand-gold-light text-white focus:ring-brand-gold",
      secondary: "bg-brand-blue hover:bg-brand-blue-light text-white focus:ring-brand-blue",
